        ...
        if (canvasRef.current) {
            ...
            SceneLoader.ImportMeshAsync("", "/", "noodle.glb", scene)
                .then((result) => {
                    ...
                    noodleIcon.position = new Vector3(-0.6, -0.2, 1);
            ...
            box1.position = new Vector3(-0.6, 0, 1); // 位置設定を修正
            box1.visibility = 0;
            ...
            SceneLoader.ImportMeshAsync("", "/", "park.glb", scene)
                .then((result) => {
                    ...
                    parkIcon.position = new Vector3(-0.3, -0.2, 1);
            ...
            box2.position = new Vector3(-0.3, 0, 1); // 位置設定を修正
            box2.visibility = 0;
            ...
            SceneLoader.ImportMeshAsync("", "/", "cafe.glb", scene)
                .then((result) => {
                    ...
                    cafeIcon.position = new Vector3(0.35, -0.2, 1);
            ...
            box3.position = new Vector3(0.35, 0, 1); // 位置設定を修正
            box3.visibility = 0;
            ...
            SceneLoader.ImportMeshAsync("", "/", "conveni.glb", scene)
                .then((result) => {
                    ...
                    conveniIcon.position = new Vector3(0.57, -0.2, 1);
            ...
            box4.position = new Vector3(0.57, 0, 1); // 位置設定を修正
            box4.visibility = 0;
